...
**Branch**: `main` | **Date**: 2025-12-04 | **Spec**: [spec.md](spec.md)
...
**Changes**:
1. 테스트 스크립트의 `create_chat_assistant()` 수정
2. 프롬프트를 한국어로 변경
3. 데이터 활용 강제 지시 추가
...
```
scripts/
├── chat_api_test.py          # Modify: prompt + parameter tuning
└── chat_quality_improvement_test.py  # New: combined test

specs/006-chat-api-quality-improvement/
├── spec.md      # Created
├── research.md  # Created
├── plan.md      # This file
